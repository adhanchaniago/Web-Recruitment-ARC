...
$status = array(
	...
	echo form_open("materi/update/$_id");
	...
	$attrcontent='width="200" cols="40" rows="20" class="editorMCE"';
	echo form_textarea($content, set_value('content',$_content),$attrcontent);
	echo "<br/>";
	//echo "<textarea width="200" class='tinyMCE' ></textarea>";
